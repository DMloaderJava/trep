  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Страница потерялась в трепе</h2>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Соцсеть для полной ерунды" },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a0bcc7cb-d4b3-4a8a-81fb-ea9bbdc610d7/id-preview-ea4139f9--84f5b6e0-4845-4d78-9eeb-f1f5cbe4e213.lovable.app-1780996600831.png",
      },
      {
        name: "twitter:image",
        content:
